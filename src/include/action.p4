...
action packet_count(index) {
	...
	register_write(global_register, index, context_metadata.count + 1);
}
...
action do_add_header_with_const(value1, mask1) {
	bit_or(HDR, HDR & (~mask1), (HDR + value1) & mask1);
}
...
action do_add_meta_with_const(value1, mask1) {
	bit_or(META, META & (~mask1), (META + value1) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_add_header_with_header(left1, right1, mask1) {
	bit_or(HDR, HDR & (~mask1), (HDR + (((HDR<<left1)>>right1)&mask1)) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_add_meta_with_header(left1, right1, mask1) {
	bit_or(META, META & (~mask1), (META + (((HDR<<left1)>>right1)&mask1)) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_add_header_with_meta(left1, right1, mask1) {
	bit_or(HDR, HDR & (~mask1), (HDR + (((META<<left1)>>right1)&mask1)) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_add_meta_with_meta(left1, right1, mask1) {
	bit_or(META, META & (~mask1), (META + (((META<<left1)>>right1)&mask1)) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_subtract_header_from_header(left1, right1, mask1) {
	bit_or(HDR, HDR & (~mask1), (HDR - (((HDR<<left1)>>right1)&mask1)) & mask1);
}
 ...
 * @param mask1 <header length> value mask
 */
action do_subtract_header_from_meta(left1, right1, mask1) {
	bit_or(META, META & (~mask1), (META - (((HDR<<left1)>>right1)&mask1)) & mask1);
}
 ...
 */
action do_add_header_1(value, mask1, mask2, length1) {
	push(byte_stack, length1*1);

	bit_or(HDR, HDR & mask1, (HDR & (~mask1) )>>(length1*8));
...
action do_remove_header_1(mask1, mask2, length1) {
	...
	bit_or(HDR, HDR & mask1, (HDR & mask2)<<(length1*8));
 ...
 * @param length1 <header length> value mask
 */
action do_mod_header_with_const_and_checksum(value, mask1, value1, value2, offset1) {
	do_mod_header_with_const(value, mask1);
	do_update_transport_checksum(value1, value2, offset1);
}
...
action do_mod_meta_with_const(value, mask1) {
	bit_or(META, (META & ~mask1), (value & mask1));
}
 ...
 * @param mask4 <>
 */
action do_mod_std_meta(val1, mask1, val2, mask2, val3, mask3, val4, mask4) {
 ...
 * @param length1 <header length> value mask
 */
action do_mod_header_with_meta_1(left1, right1, mask1) {
 ...
 * @param mask2 <header length> value mask
 */
action do_mod_header_with_meta_2(left1, right1, mask1, left2, right2, mask2) {
 ...
 */
action do_mod_header_with_meta_3(left1, right1, mask1, left2, right2, mask2, left3, right3, mask3) {
	do_mod_header_with_meta_1(left1, right1, mask1);
	do_mod_header_with_meta_1(left2, right2, mask2);
...
action do_mod_meta_with_meta_1(left1, right1, mask1) {
	bit_or(META, (META & ~mask1), (((META << left1) >> right1) & mask1));
}
 ...
 * @param mask2 	<header length> value mask
 */
action do_mod_meta_with_meta_2(left1, right1, mask1,  left2, right2, mask2) {
 ...
 * @param mask3 	<header length> value mask
 */
action do_mod_meta_with_meta_3(left1, right1, mask1, left2, right2, mask2, left3, right3, mask3) {
	do_mod_meta_with_meta_1(left1, right1, mask1);
	do_mod_meta_with_meta_1(left2, right2, mask2);
...
action do_mod_header_with_header_1(left1, right1, mask1) {
	bit_or(META, (HDR & ~mask1), (((HDR << left1) >> right1) & mask1));
	modify_field(MOD_FLAG, 1);
}
 ...
 * @param mask2 	<header length> value mask
 */
action do_mod_header_with_header_2(left1, right1, mask1, left2, right2, mask2) {
 ...
 * @param mask3 	<header length> value mask
 */
action do_mod_header_with_header_3(left1, right1, mask1, left2, right2, mask2, left3, right3, mask3) {
	do_mod_header_with_header_1(left1, right1, mask1);
	do_mod_header_with_header_1(left2, right2, mask2);
 ...
 * @param mask2 	<header length> value mask
 */
action do_mod_meta_with_header_2(left1, right1, mask1, left2, right2, mask2) {
 ...
 * @param mask3 	<header length> value mask
 */
action do_mod_meta_with_header_3(left1, right1, mask1, left2, right2, mask2, left3, right3, mask3) {
	do_mod_meta_with_header_1(left1, right1, mask1);
	do_mod_meta_with_header_1(left2, right2, mask2);
 ...
 * @param mask1
 */
action do_load_register_into_header(index, left1, mask1) {
	register_read(context_metadata.r5, global_register, index);
	bit_or(HDR, HDR & (~mask1), (context_metadata.r5<<left1) & mask1);
	modify_field(MOD_FLAG, 1);
}
 ...
 * @param mask1
 */
action do_load_register_into_meta(index,  left1,  mask1) {
	register_read(context_metadata.r5, global_register, index);
	bit_or(META, META & (~mask1), (context_metadata.r5<<left1) & mask1);
}
 ...
 * @param mask1
 */
action do_write_header_into_register(index, right1, mask1) {
	register_write(global_register, index, (HDR>>right1) & mask1);
}
...
action do_wirte_meta_into_register(index, right1, mask1) {
	register_write(global_register, index, (META>>right1) & mask1);
}
...
action do_hash_crc16(hdr_mask) {
	...
	modify_field_with_hash_based_offset(context_metadata.hash, 0,							   hash_crc16, 65536);
}
...
action do_hash_crc32(hdr_mask) {
	do_set_hash_hdr(hdr_mask);
	modify_field_with_hash_based_offset(context_metadata.hash, 0,							   hash_crc32, 0xFFFFFFFF);
}
